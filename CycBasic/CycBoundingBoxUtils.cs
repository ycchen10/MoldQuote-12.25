...
namespace CycBasic
{
    public class CycBoundingBoxUtils:CycClassItem
    {
        /// <summary>
        /// 最大外形
        /// </summary>
        ...
        public static void GetBoundingBoxInLocal(NXObject[] nxobj, CoordinateSystem cs, Matrix4 mat, ref Point3d centerPt, ref Point3d disPt)
        {
